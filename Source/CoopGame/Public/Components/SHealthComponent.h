...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FOnCharacterDiedSignature, class AController*, InstigatedBy, AActor*, DamageCauser);
...
public:	
	...
	FOnCharacterDiedSignature FOnCharacterDied;
